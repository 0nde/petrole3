...
export const translations = {
  ...
  "data.oil_core": { en: "Oil & Petroleum", fr: "Pétrole" },
  "data.energy_structure": { en: "Energy Structure", fr: "Structure énergétique" },
  "data.electricity_mix": { en: "Electricity Mix", fr: "Mix électrique" },
  "data.climate": { en: "Climate & Emissions", fr: "Climat & Émissions" },
  "data.comtrade": { en: "Trade (UN Comtrade)", fr: "Commerce (UN Comtrade)" },
  "data.source": { en: "Source", fr: "Source" },
  "data.year": { en: "Year", fr: "Année" },
  "data.verified": { en: "Verified", fr: "Vérifié" },
  "data.no_data": { en: "No verified data available", fr: "Aucune donnée vérifiée disponible" },
  "data.confidence.very_high": { en: "Machine verified", fr: "Vérifié machine" },
  "data.confidence.high": { en: "Parsed from source", fr: "Parsé depuis la source" },
  "data.confidence.medium": { en: "Human verified", fr: "Vérifié humainement" },
  "data.confidence.low": { en: "Unverified", fr: "Non vérifié" },
  "data.confidence.hypothesis": { en: "Hypothesis", fr: "Hypothèse" },

  // ── Indicator labels ──
  "indicator.structural_production": { en: "Oil production", fr: "Production pétrolière" },
  "indicator.total_consumption": { en: "Oil consumption", fr: "Consommation pétrolière" },
  "indicator.refining_capacity": { en: "Refining capacity", fr: "Capacité de raffinage" },
  "indicator.strategic_reserves": { en: "Strategic reserves", fr: "Réserves stratégiques" },
  "indicator.oil_share_energy": { en: "Oil share in energy", fr: "Part du pétrole dans l'énergie" },
  "indicator.oil_energy_per_capita": { en: "Oil per capita", fr: "Pétrole par habitant" },
  "indicator.oil_cons_change_pct": { en: "Oil consumption change", fr: "Variation conso. pétrole" },
  "indicator.primary_energy_consumption": { en: "Primary energy", fr: "Énergie primaire" },
  "indicator.energy_per_capita": { en: "Energy per capita", fr: "Énergie par habitant" },
  "indicator.population": { en: "Population", fr: "Population" },
  "indicator.electricity_generation": { en: "Electricity generation", fr: "Production d'électricité" },
  "indicator.oil_electricity": { en: "Oil electricity", fr: "Électricité pétrole" },
  "indicator.oil_share_elec": { en: "Oil share (elec.)", fr: "Part pétrole (élec.)" },
  "indicator.fossil_share_elec": { en: "Fossil share (elec.)", fr: "Part fossile (élec.)" },
  "indicator.gas_electricity": { en: "Gas electricity", fr: "Électricité gaz" },
  "indicator.coal_electricity": { en: "Coal electricity", fr: "Électricité charbon" },
  "indicator.renewables_share_elec": { en: "Renewables share", fr: "Part renouvelables" },
  "indicator.nuclear_share_elec": { en: "Nuclear share", fr: "Part nucléaire" },
  "indicator.greenhouse_gas_emissions": { en: "GHG emissions", fr: "Émissions GES" },
  "indicator.carbon_intensity_elec": { en: "Carbon intensity", fr: "Intensité carbone" },
